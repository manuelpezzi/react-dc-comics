  ...
  return (
    <section className="bg-dark py-5">
      <div className="container">
        <h2 className="text-primary mb-4 text-center">CURRENT SERIES </h2>
